                ...
                if active_req.field.name == obs.name and \
                    ...
                    if log != None:
                        log.info(obs.group_id + ': Found existing active ' + \
                                observation_classes.get_request_desc(active_req.request_type) + \
            ...
            if matching_request == False:
                ...
                if log != None:
                    log.info(obs.group_id + ': No existing active ' + \
                        observation_classes.get_request_desc(obs.request_type) + ' request for ' + obs.name + \
