# -*- coding: utf-8 -*-
"""
Created on Mon Jun 26 16:23:37 2017
...
def test_api_taplima_record():
    """Function to test the recording of a new TAPLima
    ...
    response = api_tools.submit_taplima_record(config,params)
    
if __name__ == '__main__':
    test_api_taplima_record()
