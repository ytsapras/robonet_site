...
RobonetReduction	light curve & related info		add_reduction
RobonetRequest		observing requests submitted		add_request
RobonetStatus		update event status			add_status
