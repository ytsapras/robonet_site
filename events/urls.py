...
urlpatterns = [
    ...
    url(r'^query_event_in_survey/ra=(?P<ra>[0-9.]+)&dec=(?P<dec>[-0-9.]+)/$', views.query_event_in_survey, name='query_event_in_survey'),
    ...
    url(r'^set_event_status_api/$', views.set_event_status, name='set_event_status'),
    url(r'^set_event_status_api/event_name=(?P<event_name>[A-Za-z0-9]+)&status=(?P<status>[A-ZA-Z])/$', views.set_event_status_api, name='set_event_status_api'),
    url(r'^list_year/(?P<year>[0-9]+)', views.list_year, name='list_year'),
    url(r'^list_all/$', views.list_all, name='list_all'),
    url(r'^list_all/(?P<display_year>[A-Za-z0-9]+)/$', views.list_all, name='list_all'),
    url(r'^display_fields/', views.display_fields, name='display_fields'),
    url(r'^search_events/$', views.search_events, {'search_type':'name'}, name='search_events'),
    url(r'^search_events/search_event_name/$', views.search_events, {'search_type':'name'}, name='search_event_name'),
    url(r'^search_events/search_event_position/', views.search_events, {'search_type':'position'}, name='search_event_position'),
    url(r'^search_events/search_event_params/$', views.search_events, {'search_type':'params'}, name='search_event_params'),
